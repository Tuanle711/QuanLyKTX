...
<head>
        <title>QUẢN LÝ SINH VIÊN KÍ TÚC XÁ TÀI NGUYÊN MÔI TRƯỜNG HÀ NỘI</title><meta charset="UTF-8" />
    ...
    <body>
        <div id="loginbox">            
            <form id="loginform" class="form-vertical" action="" method="post">
				 <div class="control-group normal_text"> <h3><img src="img/logo1.jpg" alt="Logo" /></h3></div>
            ...
            <form id="recoverform" action="#" class="form-vertical" method="post">
				<p class="normal_text">Nhập lại mật khẩu</p>

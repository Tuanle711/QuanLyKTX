...
<script>
	...
	function Sua(){
		return echo("Bạn có sửa mục này");
		}	
</script>
...
<body> 
    ...
    <div id="header">
      <h1>
      	<img src="img/logo.png" alt="" class="img-scaledown">
    ...
    <div id="sidebar"><a href="" class="visible-phone"><i class="icon icon-home"></i> Menu</a>
      <ul>
        ...
        <li class="active"><a href="?page=dashboard"><i class="icon icon-home"></i> <span>Menu</span></a> </li>
        ...
        <li class="submenu "> <a href="#"><i class="icon icon-th-list"></i> <span>Điện Nước</span> </a>
          <ul>
            ...
            <li><a href="?page=Update-DonGia">Cập Nhật Giá Điện Nước</a></li>
        ...
        <li class="submenu "> <a href="#"><i class="icon icon-th-list"></i> <span>Quản Lý Cơ Sở Vật Chất</span> </a>
          <ul>
            <li><a href="?page=QL-CSVC">Cơ sở vật chất</a></li>
	...
	switch($page)
	{
        ...
        /* QL SV */
    case "QL-CSVC":
      include("include/CoSoVatChat/QL-CSVC.php");
    break;
	}
?>
    <!--End Dieu Huong--> 
    ...
    <div class="row-fluid">
      <div id="footer" class="span12"> 2013-<?php echo date('Y');?> &copy; </a> </div>
    </div>
